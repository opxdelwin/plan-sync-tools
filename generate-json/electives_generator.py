...
def parse_elective_string(elective_str: str) -> tuple[str, str]:
    ...
    try:
        ...
        return room.strip(), subject.strip()
    except Exception:
        return None, None
